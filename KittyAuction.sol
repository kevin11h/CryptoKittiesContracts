...
contract KittyAuction is KittyBreeding {
  ...
  function setSiringAuctionAddress(address _address) external onlyCEO {
      SiringClockAuction candidateContract = Siring ClockAuction(_address);
      
      // NOTE: verify that a contract is what we expect - https://github.com/Lunyr/crowdsale-contracts/blob/cfadd15986c30521d8ba7d5b6f57b4fefcc7ac38/contracts/LunyrToken.sol#117
  ...
  /// Does some ownership trickery to create auction in one tx.
      ...
      whenNotPausecontract 
  {
      ...
      // NOTE: kthe kitty IS allowed to be in a cooldown.
  ...
  function createSiringAuction(
        ...
        whenNotPaused
    {
        ...
        // Auction contract checks input sizes
        // If kitty is already on any auction, this will throw
        // because it will be owned by the auction conract.
        require(_owns(msg.sender, _kittyId));
    ...
    /// prevent two transfer calls in the auciton bid function.
